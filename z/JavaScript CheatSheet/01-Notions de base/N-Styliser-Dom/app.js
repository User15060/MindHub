...
// textContent : Il s'agit d'une propriété qui permet d'obtenir ou de définir le contenu textuel d'un élément du DOM. Elle renvoie
// le texte brut contenu dans un élément, sans prendre en compte le balisage HTML éventuel. 

str1.textContent = "Je suis du texte de textContent"

// innerText : C'est une propriété similaire à textContent, mais elle renvoie le texte visible à l'écran, en ignorant le contenu des
// éléments qui peuvent être masqués ou affectés par des styles CSS (comme display: none). Elle est sensible à la mise en forme et à la
// disposition des éléments.

str2.innerText = "Je suis du texte depuis innerText"

// innerHTML : Il s'agit d'une propriété qui permet d'obtenir ou de définir le contenu HTML d'un élément du DOM.
// Elle renvoie le balisage HTML inclus à l'intérieur de l'élément, y compris tous les éléments enfants.
// Vous pouvez également utiliser cette propriété pour insérer du HTML dans un élément.
